...
class Calculator(QDialog):
    ...
    def init_ui(self):
        ...
        self.add(button_plus)
        self.subtract(button_minus)
        self.multiply(button_product)
        self.divide(button_division)
    ...
    def add(self, button_plus):
        button_plus.clicked.connect(lambda state, operation = '+': self.button_operation_clicked(operation))
    def subtract(self, button_minus):
        button_minus.clicked.connect(lambda state, operation = '-': self.button_operation_clicked(operation))
    def multiply(self, button_product):
        button_product.clicked.connect(lambda state, operation = '*': self.button_operation_clicked(operation))
    def divide(self, button_division):
